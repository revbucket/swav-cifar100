...
def get_cifar100_dataloader(batch_size, train=True, transform=Augment(224)):
    dataset = CIFAR100(root="~/datasets", train=train, transform=transform, download=True)
    return DataLoader(dataset=dataset, batch_size=batch_size, num_workers=4, drop_last=True)
...
loader_train = get_cifar100_dataloader(batch_size=BATCH_SIZE, train=True, transform=data_transform)
loader_train_plain = get_cifar100_dataloader(batch_size=BATCH_SIZE, train=True, transform=test_transform)
loader_test = get_cifar100_dataloader(batch_size=BATCH_SIZE, train=False, transform=test_transform)
